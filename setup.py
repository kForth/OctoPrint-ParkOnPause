...
plugin_identifier = "ParkOnPause"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_ParkOnPause"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-ParkOnPause"
...
# module
plugin_description = """Park the print head at a specific location when pausing a print."""
...
plugin_url = "https://github.com/kForth/OctoPrint-ParkOnPause"
